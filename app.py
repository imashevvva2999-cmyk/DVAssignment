...
st.set_page_config(page_title="Assignment III: Bike Rental Dashboard", layout="wide")
...
st.title("Bike Rental Dashboard (2011-2012)")
st.markdown("**Summarizing bike rental trends from 2011-2012**")
st.markdown("---")
...
with col1:
    ...
    fig, ax = plt.subplots(figsize=(10, 5))
    colors_days = ["#1f77b4"] * 5 + ["#ff7f0e", "#2ca02c"] 
